...
// Stats strip shown below portrait
function StatStrip() {
  const stats = [
    ...
    <div className="glass-card rounded-xl px-4 py-3 w-full mt-3">
      <div className="flex items-center justify-between gap-2">
        {stats.map(({ number, label }, i) => (
          ...
          >
            <div className="text-sm md:text-base lg:text-lg font-bold text-gradient leading-none">
              {number}
            </div>
            <div className="text-[9px] text-textMuted font-mono mt-0.5 leading-tight whitespace-nowrap">
              {label}
            </div>
          </div>
        ))}
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-10 lg:gap-16">
          ...
          >
            ...
            <motion.h1
              ...
              variants={heroReveal}
              custom={1}
              className="text-[clamp(2.6rem,8vw,7.5rem)] font-bold leading-[0.93] tracking-[-0.04em] mb-6"
          ...
          <motion.div
            ...
            aria-label="Khadijah Abdulwasii portrait"
          >
            {/* Portrait with glow + brand tint */}
